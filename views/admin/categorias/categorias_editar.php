...
<main class="container py-5">
    <div class="row mb-4">
        <div class="col text-center">
            <h1 class="h2 text-success">Editar categoría</h1>
        </div>
    </div>

    <div class="row justify-content-center">
        <div class="col-md-6">
            <form method="POST" action="index.php?controller=categorias&action=editar&id=<?= $categoria['id_categoria'] ?>">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select name="id_padre" class="form-select" required>
                        <option value="1" <?= ($categoria['id_padre']==1)?"selected":"" ?>>Hombre</option>
                        <option value="2" <?= ($categoria['id_padre']==2)?"selected":"" ?>>Mujer</option>
                    </select>
                </div>
